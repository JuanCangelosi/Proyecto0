...
public class Celda {
	 ...
	 * 
	 * @param es
	 *            es el estado de la celda: piso, pared o pared destruible
	 * @param map
	 *            es el mapa al que pertenece la celda
	 * @param x
	 *            la posicion X de la celda en la matriz
	 * @param y
	 *            la posicion Y de la celda en la matriz
	 */
	 ...
	 * 
	 * @return null si no hay un bomberman en la celda y el bomberman en caso
	 *         contrario.
	 */
	 ...
	 * 
	 * @return null si no hay enemigo en la celda, y el enemigo en caso
	 *         contrario
	 */
	 ...
	 * 
	 * @param bm
	 *            el bomberman que se desea setear en la celda
	 */
	 ...
	 *            Bomberman
	 * @param n
	 *            es la direccion del movimiento; 0 para arriba, 1 para abajo, 2
	 *            para izquierda, 3 para derecha
	 */
	 ...
	 * 
	 * @param enem
	 *            el enemigo que se desea setear en la celda.
	 */
	 ...
	 * 
	 * @param enem
	 *            : el enemigo que desa avanzar
	 * @param n
	 *            : la posicion de avance 0=arriba, 1=abajo, 2= izq, 3= der
	 */
	 ...
	 * 
	 * @param bomb
	 *            bomba que se desea setear en la celda
	 */
	 ...
	 * 
	 * @param est
	 *            estado que se le seteara a la celda
	 */
