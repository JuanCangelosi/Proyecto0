...
public interface EstadoCelda {
	 ...
	 * @param c la celda a la que pertenece el estado
	 * @return el puntaje de la explosion
	 */
	public int destruir(Celda c);
	/**
	 * Decidira si el personaje puede avanzar, y si se le puede otorgar el powerup
	 * @param b: bomberman que quiere avanzar
	 * @param p: powerup que posee la celda (puede ser nulo)
	 * @param c: celda a la que pertenece el estado
	 * @param n: la direccion de avance 0=arriba, 1=abajo, 2= izq, 3=der
	 */
	public void serAvanzado(Bomberman b,PowerUp p,Celda c,int n);
	/**
	 * Decidira si el enemigo puede avanzar,
	 * @param e: enemigo que quiere avanzar
	 * @param c: celda a la que pertenece el estado
	 * @param n: la direccion de avance 0=arriba, 1=abajo, 2= izq, 3=der
	 */
	 ...
	 * @param b: la bomba que se desea colocar
	 * @param c: la celda a la que pertence el estado
	 */
	 ...
	 * @param e: estadografico a setear
	 */
